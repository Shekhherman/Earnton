...
class Analytics:
    ...
    def initialize_db(self):
        ...
        try:
            ...
            logger.error(f"Error creating user_activity table: {str(e)}")
            raise
        ...
        try:
            ...
            logger.error(f"Error creating video_analytics table: {str(e)}")
            raise
    ...
    async def log_video_view(self, video_id: int, user_id: int, watch_time: float, rating: Optional[float] = None) -> None:
